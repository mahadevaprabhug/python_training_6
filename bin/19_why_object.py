"""
Why Object Concept? or Object Oriented Programming ?

In this section,
1. Encapsulation: Keeping data and related methods/variables together
2. Abstraction: Through methods, we are achieving this. We just need to know
        what each method is doing, NO NEED to know how each method is implemented
"""

print("DATA inside 'str' object:")
print("-"*20)
# --------------
...
print("METHODS/VARIABLES present inside 'str' class object")
print("-"*20)
# --------------
